...
import model.MuteGenreLatentVAE.components as components


class MuteGenreLatentVAE(torch.nn.Module):
    """
    ...
    def __init__(self, config):
        ...
        super(MuteGenreLatentVAE, self).__init__()
...
if __name__ == "__main__":
    ...
    model = MuteGenreLatentVAE(config)
